...
// OpenAI brand palette — design tokens live in theme.h
#include "theme.h"
...
// Per-frame hold time. Modeled on Codex's spinner (Cavalry triangle
...
static void init_bluetooth_screen(lv_obj_t* scr) {
    ...
    lv_label_set_text(lbl_credit, "CodexMeter prototype");
    ...
    lv_label_set_text(lbl_credit2, "Adapted from Clawdmeter");
