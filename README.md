...
This project is adapted from [HermannBjorgvin/claudemeter](https://github.com/HermannBjorgvin/claudemeter). The current firmware targets an M5Stack AtomS3 ESP32-S3 with its built-in 0.85-inch display, and the host daemon defaults to USB serial updates for reliability.
