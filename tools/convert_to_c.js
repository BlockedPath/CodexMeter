...
const IN_DIR = path.resolve(opt('--in', path.join(__dirname, 'codexpix_data')));
...
function main() {
  if (!fs.existsSync(IN_DIR)) {
    console.error(`No scraped data at ${IN_DIR}. Run scrape_codexpix.js first.`);
    process.exit(1);
  }
  ...
  out += '// Source: https://codexpix.vercel.app (20x20 pixel-art creature\n';
  out += '// animation library). Frames extracted by tools/scrape_codexpix.js\n';
